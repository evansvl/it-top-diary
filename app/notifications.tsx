    ...
    <SafeAreaView className="flex-1 bg-canvas" edges={['top']}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 32 }}>
        ...
        <Text className="mt-4 px-1 text-xs text-faint">
          Уведомления считаются на устройстве. В фоне приложение периодически
          проверяет новые события, а дедлайны и оплату планирует заранее. Точный
          интервал фоновых проверок определяет система.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
